...
sudo ../configure --target-list=riscv64-softmmu,riscv64-linux-user --prefix=/usr/local/bin/qemu-riscv64 --static --disable-system --enable-linux-user
sudo make -j24
sudo make install -j24
```
